...
Das folgende Sequenzdiagramm zeigt die Szenario einer Mitteilung. Zu Beginn erhält die Smartphone die Nachricht ("message"). Die erhaltene Nachricht leitet er weiter an Smartwatch mit dem Operator sendMessage(). Danach wird die Nachricht im Display angezeigt, das Smartwatch schickt dem Display eine Nachricht mit showMessage() und zur selben Zeit kann eine Benachrichtigung stattfinden. Dabei gibt es vier Möglichkeiten einer Benachrichtigung.
1.: Der Bedingung ist, dass Vibration und Sound an ist. Das Smartwatch vibriert und anschließend kommt auch eine Benachrichtigungston.
2.: Der Bedingung ist, dass Vibration an und Sound aus ist. Das Smartwatch vibriert, allerdings kommt kein Benachrichtigungston.
3.: Der Bedingung ist, dass Vibration aus und Sound an ist. Das Smartwatch vibriert nicht, stattdessen kommt ein Benachrichtigungston.
4.: else. Vibration und Sound ist aus.
