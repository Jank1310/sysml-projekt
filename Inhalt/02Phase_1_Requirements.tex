...
Abbildung~\ref{fig:requirement_diagram_akku} zeigt das Requirement Diagramm der Requirements der Kategorie Kapazität. Besonders hervorzuheben ist die Abhängigkeit zwischen \textbf{Akkuladezeit} und \textbf{Akku: Induktionsladen}. Mittels des \gls{Stereotyp} \textbf{deriveReqt} wird signalisiert, dass \textbf{Akku: Induktionsladen} eine Erweiterung des Requirements \textbf{Akkuladezeit} ist, das bedeutet, dass für das Laden mittels Induktion die Ladezeitvorgabe (2 Stunden) des Akkuladezeit-Requirements gilt.
